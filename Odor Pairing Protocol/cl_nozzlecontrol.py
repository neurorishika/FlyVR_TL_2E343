...
def transform_angle(fictrac_heading):    
    nozzle_home_angle = -32-90 # angle between nozzle home and the orientation of fly, clockwise as positive
...
def main():
    ...
    # dev.get_device_id()
    # dev.get_methods()
    dev.velocity_max('setValue',[1000]) # about 0.25 s per turn (1536/6000)
    dev.acceleration_max('setValue',[1000]) # 6/8 s to accerelate to max 
